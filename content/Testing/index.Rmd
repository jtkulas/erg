...
The 5-state [pure-gas.org](https://www.pure-gas.org/) database of stations is also searchable via the following table:

```{r missingstations, warning=FALSE, echo=FALSE}

library(DT)
widgetframe::frameWidget(datatable(states[c(5,7,2,9,4,6)], rownames=FALSE, options = list(pageLength = 5)))  
