...
# Example #1 codename: `r emo::ji("fuel_pump")`
...
```{r map2, echo=FALSE, warning=FALSE, fig.cap="Searchable 5-state region ethanol-free petrol map."}
...
# Example #2 codename: `r emo::ji("football")`
