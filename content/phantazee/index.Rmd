...
## "Bottom" 5 per position (ranked 15-20; QB, RB, WR)
...
Smoothed averages by position ("Bottom" #'s15-20 per week):
...
```{r box3, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Boxplot estimates show variability within groups of Bottom #'s15-20."}
...
```{r jitter3, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Jittered points Bottom #'s15-20 (qb, wr, rb)."}
